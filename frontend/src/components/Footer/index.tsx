        ...
        <MDBContainer className="text-center text-md-start mt-2">
          ...
          <MDBRow>
            <div className="footer-download-zone">
              <p><i style={{marginRight:"2px"}}><BiDownload/></i> See the source code and download the project here:</p><a href="https://github.com/LorenzoBondan/SoccerLeague"><p style={{color:"#00ADB5"}}>https://github.com/LorenzoBondan/SoccerLeague</p></a>
            </div>
          </MDBRow>
        </MDBContainer>
      </section>
